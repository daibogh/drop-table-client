  ...
  const getCriteriaCard = useCallback((criteria) => {
    return (
      <Line key={criteria.id} className="criteria-card" alignItems="center" justifyContent="between">
        ...
        <TextBoxField name="criteria-weight" value={criteria.weight} onChange={() => {}} type="number" />
      </Line>
    );
  }, []);
  ...
  return (
    ...
    <Line className="ProgramPage">
      <Line vertical w="50">
        ...
        <TextBoxField name="title" value="Программная инженерия" onChange={() => {}}>
          Название
        </TextBoxField>
        {/* <TextareaField name="description" value="Очень хорошая программа всем советую" onChange={() => {}}>
          Описание
        </TextareaField> */}
        <TextBoxField name="hours" value="1000" onChange={() => {}} type="number">
